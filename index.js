...
function drawRouletteWheel2() {
  ...
  if (canvas2.getContext) {
    ...
    for(var i = 0; i < options2.length; i++) {
      var angle = startAngle + i * arc;
      //ctx.fillStyle = colors[i];
      ctx.fillStyle = getColor(i, options2.length);
...
function rotateWheel2() {
  ...
  var spinAngle = spinAngleStart - easeOut2(spinTime, 0, spinAngleStart, spinTimeTotal);
  startAngle += (spinAngle * Math.PI / 180);
  drawRouletteWheel2();
  spinTimeout = setTimeout('rotateWheel2()', 30);
}
